...
fits = list(
    dynamic_27 = iterate_fits(observed, dynamic, "bup", "27"), 
    dynamic_30 = iterate_fits(observed, dynamic, "bup", "30"), 
    dynamic_51 = iterate_fits(observed, dynamic, "bup", "51"), 
    threshold_27 = iterate_fits(observed, threshold, "bup", "27"), 
    threshold_30 = iterate_fits(observed, threshold, "bup", "30"),
    threshold_51 = iterate_fits(observed, threshold, "bup", "51"), 
    hybrid_27 = iterate_fits(observed, hybrid, "bup", "27"), 
    hybrid_30 = iterate_fits(observed, hybrid, "bup", "30"), 
    hybrid_51 = iterate_fits(observed, hybrid, "bup", "51"), 
    constant_27 = iterate_fits(observed, constant, "bup", "27"), 
    constant_30 = iterate_fits(observed, constant, "bup", "30"),
    constant_51 = iterate_fits(observed, constant, "bup", "51")
)

saveRDS(fits, "data/drv/lmtp•fits•bytrial•sdr•010422.rds")
