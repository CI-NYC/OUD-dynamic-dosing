...
desc = data.frame(
  ...
  description = c(
    ...
    "fuzed 12-week survival outcome: date of first non-study opioid use [OR ?? if no relapse]",
    ...
    "history of alcohol use disorder (or is it current ??)",
    "history of cocaine use disorder (or is it current ??)",
    "has brain damage",
    "has epilepsy",
    "has schizophrenia",
    "has bipolar disorder",
    "hasAnxPan -- has anxiety disorder ??",
